...
create table tb_veiculo (id  bigserial not null, ano int4, capacidade_tanque varchar(255), chassi varchar(255), patrimonio varchar(255), placa varchar(255), renavan varchar(255), tipo_combustivel int4, versao varchar(255), id_tipo_fk int8, primary key (id));
